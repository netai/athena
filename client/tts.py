# -*- coding: utf-8-*-
"""
A Speaker handles audio output from athena to the user
...
class AbstractTTSEngine(object):
    ...
    def play(self, filename):
        ...
        # See issue athenaproject/athena-client#188
...
class EspeakTTS(AbstractTTSEngine):
    """
    Uses the eSpeak speech synthesizer included in the athena disk image
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='athena TTS module')
